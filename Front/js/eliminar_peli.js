    ...
    fetch(URL + 'productos') // Realiza una solicitud GET al servidor y obtener la lista de productos.
        ...
        .then(data => {
            const productosTable =
                ...
                document.getElementById('productos- table').getElementsByTagName('tbody')[0]; productosTable.innerHTML = ''; // Limpia la tabla antes de insertar nuevos datos
...
<td align="right">${producto.info}</td>
...
// Cuando la página se carga, llama a obtenerProductos para cargar la lista de productos.document.addEventListener('DOMContentLoaded', obtenerProductos);
